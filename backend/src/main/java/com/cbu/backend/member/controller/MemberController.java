...
public class MemberController {
    ...
    @PostMapping
    public ResponseEntity<Void> registerMember(Principal principal,@RequestBody CreateMemberRequest dto) {
    ...
    @PutMapping
    public ResponseEntity<Void> updateMember(Principal principal, @RequestBody UpdateMemberRequest dto) {
