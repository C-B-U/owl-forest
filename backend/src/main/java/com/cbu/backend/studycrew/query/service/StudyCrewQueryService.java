...
public class StudyCrewQueryService {
    ...
    public List<StudyCrewResponse> getStudyCrewSortByCreatedAt(SortDirection sortDirection, Pageable pageable) {
        return getStudyCrewList(studyCrewQueryRepository::getStudyCrewSortByCreatedAt, sortDirection, pageable);
    }

    public List<StudyCrewResponse> getStudyCrewSortByLikeCount(SortDirection sortDirection, Pageable pageable) {
        return getStudyCrewList(studyCrewQueryRepository::getStudyCrewSortByLikeCount, sortDirection, pageable);
    }

    private List<StudyCrewResponse> getStudyCrewList(BiFunction<SortDirection, Pageable,
            List<StudyCrew>> function, SortDirection sortDirection, Pageable pageable) {
