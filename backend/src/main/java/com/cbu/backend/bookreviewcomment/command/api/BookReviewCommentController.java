...
public class BookReviewCommentController {
    ...
    @PostMapping
    public ResponseEntity<BookReviewCommentNo> save(
            @AuthenticationPrincipal LoginUser loginUser,
            @RequestBody BookReviewCommentRequest dto) {
        BookReviewCommentNo bookReviewCommentId =
                bookReviewCommentService.saveBookReviewComment(
                        dto.toBookReviewRequest(loginUser.getAccountId()));
