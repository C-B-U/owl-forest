...
public class BoardController {
    ...
    public ResponseEntity<ResponseFormat<BoardResponse>> update(
        ...
        ResponseFormat<BoardResponse> responseFormat = new ResponseFormat<>(ResponseStatus.UPDATE_BOARD_SUCCESS, updatedBoard);
    ...
    public ResponseEntity<ResponseFormat<BoardResponse>> delete(@PathVariable Long id) {
        ...
        ResponseFormat<BoardResponse> responseFormat = new ResponseFormat<>(ResponseStatus.DELETE_BOARD_SUCCESS, deletedBoard);
    ...
    public ResponseEntity<ResponseFormat<BoardResponse>> findById(@PathVariable Long id) {
        ...
        ResponseFormat<BoardResponse> responseFormat = new ResponseFormat<>(ResponseStatus.GET_BOARD_SUCCESS, board);
    ...
    public ResponseEntity<ResponseFormat<List<BoardResponse>>> getAll(Pageable pageable) {
        ...
        ResponseFormat< List<BoardResponse>> responseFormat = new ResponseFormat<>(ResponseStatus.GET_BOARD_LIST_SUCCESS, boards);
