...
public class StudyPlanController {
  ...
  public ResponseEntity<ResponseFormat<StudyPlanResponse>> create(
    ...
    ResponseFormat<StudyPlanResponse> responseBody =
        new ResponseFormat<>(ResponseStatus.POST_STUDYPLAN_SUCCESS, result);
  ...
  public ResponseEntity<ResponseFormat<StudyPlanResponse>> updateStudyPlan(
      UpdateStudyPlanRequest dto, @PathVariable Long studyGroupId) {
