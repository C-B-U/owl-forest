...
public class StudyPlanController {
    ...
    @PostMapping
    public ResponseEntity<StudyPlanIdResponse> saveStudyPlan(@RequestBody StudyPlanRequest studyPlanRequest) {
        return ResponseEntity.ok(studyPlanService.saveStudyPlan(studyPlanRequest));
    }

    @PutMapping("/{id}")
    public ResponseEntity<Void> putStudyPlan(@PathVariable Long id, @RequestBody StudyPlanRequest studyPlanRequest) {
