...
class StudyGroupQueryDslDaoImplTest {
    ...
    @Autowired
    StudyGroupQueryDslDaoImpl studyGroupQueryDslDao;
...
//    }
    ...
    class FindList {
        ...
        void successByCreatedAt() throws Exception {
            ...
            result.forEach( r -> {
                log.info("{}, {}, {}, {}, {}, {}",r.getId(), r.getName(), r.getStudyGroupStatus(), r.getLikeCount(), r.getDescription(), r.getStudyLeader().getId());
            });
