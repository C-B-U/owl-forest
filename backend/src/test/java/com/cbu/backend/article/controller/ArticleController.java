...
public class ArticleController {
  ...
  public ResponseEntity<ResponseFormat<ArticleResponse>> create(
      @PathVariable Long boardId, @RequestBody ArticleRequest dto) {
    ArticleResponse savedArticle = articleService.create(boardId, dto);
    ResponseFormat<ArticleResponse> responseFormat =
        new ResponseFormat<>(ResponseStatus.POST_ARTICLE_SUCCESS, savedArticle);
  ...
  public ResponseEntity<ResponseFormat<List<ArticleResponse>>> findAllByBoardId(
    ...
    ResponseFormat<List<ArticleResponse>> responseFormat =
        new ResponseFormat<>(ResponseStatus.GET_ARTICLE_LIST_SUCCESS, articles);
  ...
  public ResponseEntity<ResponseFormat<ArticleResponse>> findById(
    ...
    ResponseFormat<ArticleResponse> responseFormat =
        new ResponseFormat<>(ResponseStatus.GET_ARTICLE_SUCCESS, article);
