...
public abstract class RestDocumentTest {
    ...
    protected Principal loginUser = new UsernamePasswordAuthenticationToken(new LoginUser(new AccountNo(), null, null), null);
    @MockBean
    ...
    @BeforeEach
    public void setupMockMvc(WebApplicationContext ctx,
