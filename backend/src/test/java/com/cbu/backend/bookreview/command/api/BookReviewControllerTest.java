...
import com.cbu.backend.support.docs.RestDocsConfiguration;
    ...
    void createBookReview() throws Exception {
        ...
        ResultActions perform = mockMvc.perform(
                post("/api/book-reviews")
                        ...
                        .content(toRequestBody(BookReviewRequestFixture.SAMPLE1.getBokReviewRequest())));
        //then
        ...
        //docs
        perform.andDo(print())
                .andDo(document("create book review",
                        getDocumentRequest(),
                        getDocumentResponse()
                ));
