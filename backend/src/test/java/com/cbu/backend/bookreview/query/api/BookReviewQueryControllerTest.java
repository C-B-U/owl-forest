...
class BookReviewQueryControllerTest extends RestDocumentTest {
    ...
    class findBookReview {
        ...
        void successFindAll() throws Exception {
            //given
            List<BookReviewSummaryResponse> expected = List.of(
            ...
            ResultActions perform =
                    mockMvc.perform( get("/api/book-reviews"));
            //then
            ...
            //docs
            perform.andDo(print())
                    .andDo(document("search book review list", getDocumentRequest(), getDocumentResponse()));
        }
        @Test
        ...
        void successFindAllPagingOption() throws Exception {
            ...
            //docs
            perform.andDo(print())
                    .andDo(document("search book review list Paging Option", getDocumentRequest(), getDocumentResponse()));
        }
        ...
        void successFindAllSearchOption() throws Exception {
            ...
            //docs
            perform.andDo(print())
                    .andDo(document("search book review list Search Option", getDocumentRequest(), getDocumentResponse()));
        }
        ...
        void successFindById() throws Exception {
            ...
            ResultActions perform =
                    mockMvc.perform(
                            get("/api/book-reviews/{id}", expected.getId().getId())
                    );
            //then
            perform.andExpect(status().isOk())
                    .andExpect(jsonPath("$.id.id").value(expected.getId().getId().toString()))
                    .andExpect(jsonPath("$.writer.id.id").value(expected.getWriter().getId().getId().toString()))
                    .andExpect(jsonPath("$.writer.nickname").value(expected.getWriter().getNickname()))
                    .andExpect(jsonPath("$.title").value(expected.getTitle()))
                    .andExpect(jsonPath("$.content").value(expected.getContent()))
                    .andExpect(jsonPath("$.book.id.id").value(expected.getBook().getId().getId().toString()))
                    ...
                    .andExpect(jsonPath("$.book.publisher").value(expected.getBook().getPublisher()))
            ...
            //docs
            perform.andDo(print())
                    .andDo(document("search book-review by id", getDocumentRequest(), getDocumentResponse()));
